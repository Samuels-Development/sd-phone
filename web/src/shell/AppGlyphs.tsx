import {
    ...
    Hourglass, House, IceCreamCone, Image as ImageIcon, Images, Inbox, Joystick, Key, KeyRound,
    ...
    ScanSearch, ScrollText, Search, Send, Settings, Shield, ShieldCheck, ShieldHalf, Ship,
    ...
    Sun, SwitchCamera, Swords, Tag, Target, ThumbsUp, Ticket, Timer, ToggleRight, TrainFront,
